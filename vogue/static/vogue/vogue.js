...
const translateY = ( (navLogo.bottom - navLogo.top)/2 ) - (logo.top + (logo.bottom - logo.top)/2 );
...
const rulebookLink = document.querySelector(".comp-rulebook-link").getAttribute('href');
